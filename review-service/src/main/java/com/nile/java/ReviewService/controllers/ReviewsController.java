...
public class ReviewsController {
    ...
    public void deleteReviews(@RequestHeader("Authorization") String token, @PathVariable("id") UUID id, @RequestBody Review review) {
        reviewsService.deleteReview(token, id);
    }
